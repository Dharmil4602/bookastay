...
function UpdateServiceProvider() {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/getServiceProfile`, {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/updateServiceProfile/${businessUser._id}`, {
                method: "PUT",
                headers: {
