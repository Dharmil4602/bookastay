...
const AddListing = () => {
    ...
    const handleStartDateChange = (date) => {
        ...
        // Update startDate in formData
        // if (date > endDate) {
        //     setEndDate(date);
        //     setFormData({ ...formData, endDate: date }); // Update endDate in formData if it's less than startDate
        // } else {
        //     setStartDate(date);
        //     setFormData({ ...formData, startDate: date });
        // }
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm) {
            try {
                ...
                console.log("image in form data: ", formData.images);
                ...
                // toas/t.error("Error adding listing.");
            }
        } else {
    ...
    const inputFields = [
        ...
        // { name: "Start Date", label: "Check-in Date", placeholder: "Enter check-in date" },
        // { name: "End Date", label: "Check-out Date", placeholder: "Enter check-out date" }
    ];
